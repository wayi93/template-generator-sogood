...
export default class Body_v_18_03 extends Component{
						...
						<div className="col-md-12">
							<div id="tab-container" className="tab-container">
								<div id="content1" className="active">
									...
									<EbayProducts action={ this.props.action } initDatas={ (locInitDatas.EPS_1 === null) ? this.state.blocks.EPS_1 : locInitDatas.EPS_1 } idPrefix={'EPS_1'} setBodyDatas={this.setBodyDatas} nrInRow={4} hasTitle={true} colClassName={'col-md-3'} imgLinkInternalPrefix={ this.props.imgLinkInternalPrefix } />
									...
									<EbayProducts action={ this.props.action } initDatas={ (locInitDatas.EPS_2 === null) ? this.state.blocks.EPS_2 : locInitDatas.EPS_2 } idPrefix={'EPS_2'} typ={'//BESTSELLER'} setBodyDatas={this.setBodyDatas} nrInRow={5} hasTitle={true} colClassName={'col-md-1-5'}  imgLinkInternalPrefix={ this.props.imgLinkInternalPrefix } />
